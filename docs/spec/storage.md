...
> **Authority:** Authoritative specification for the MEDRE storage layer: SQLite schema, StorageBackend protocol, path resolution, durability guarantees, and replay receipt storage semantics.
...
listed target_stages are the complete stage sets including the store baseline
plus any mode-specific stages.
