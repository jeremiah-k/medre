...
| **Reconnect model**                 | Exponential backoff, 10 attempts, 1–60 s | Lifetime MEDRE client recreation, capped 1–30 s backoff; mtjk owns low-level TCP recovery | Exponential backoff, 10 attempts, 1–30 s | Exponential backoff, 10 attempts, 1–30 s |
