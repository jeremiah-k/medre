...
> Supersedes: Nothing. Extracts and formalizes maturity assessment from contracts 28, 32, 33, 35, 36.
...
2. **Duplicate-send risk.** Session retries transient failures up to 3 times. Consumers must handle duplicates.
