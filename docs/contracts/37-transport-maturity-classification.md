...
> Tranche 6 session (2026-05-25): Docker Synapse E2EE harness executed 3/3 (2026-05-25, `tests/integration/test_synapse_e2ee_smoke.py`, Python 3.12.3, Synapse v1.153.0). Third-party inbound confirmed at Docker SDK-boundary via second nio client. External-live third-party inbound NOT confirmed. This update adds Docker E2EE evidence classification, Docker SDK-boundary sub-classification for R-tier Matrix evidence, and clarifies evidence artifact locations. No maturity tiers were promoted.
...
| **Live-test maturity**     | High        | H-tier: 13/13 plaintext pass against matrix.org (2026-05-10, historical). H-tier: 7/7 E2EE pass in encrypted room (2026-05-10, historical). R-tier Docker SDK-boundary: 15/1 xf pass against local Docker Synapse (2026-05-22). R-tier Docker SDK-boundary E2EE: 3/3 pass with encrypted-room send/receive and third-party inbound via second nio client (2026-05-25). Third-party inbound confirmed at Docker SDK-boundary (2026-05-25); external-live third-party inbound NOT confirmed. No current-tranche external live re-run (2026-05-12 credential failures). Per STATUS.md, Matrix is `live-validated` on recorded evidence (H-tier + Docker SDK-boundary). |
...
5. **Third-party inbound confirmed at Docker SDK-boundary only.** Third-party inbound from a second nio client confirmed in Docker Synapse E2EE harness (2026-05-25, R-tier Docker SDK-boundary). External-live third-party inbound from a real second Matrix account on an external homeserver remains unconfirmed.
...
| Axis                       | Rating                                          | Evidence                                                                                                                                                                                                                                                                                                                     |
| -------------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Architectural maturity** | Moderate                                        | Full adapter suite: codec (138 LOC), renderer (177 LOC), session (701 LOC), adapter (489 LOC), config (168 LOC), errors (45 LOC), compat (20 LOC), packet_classifier (84 LOC). Async-native (no thread bridging).                                                                                                            |
| **Unit-test maturity**     | Moderate–High                                   | 8,687 LOC across 15 test files. `test_meshcore_session.py` has 51 test functions across 22 classes. Covers codec, renderer, adapter, session, config, boundaries, pipeline, packet_classifier, live, diagnostics, operational boundaries, evidence, ingress, wrapper.                                                        |
...
| Axis                       | Rating                                          | Evidence                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Architectural maturity** | Moderate                                        | Full adapter suite: codec (154 LOC), renderer (190 LOC), session (1,457 LOC — largest session), adapter (428 LOC), config (164 LOC), errors (49 LOC), compat (54 LOC), fields (210 LOC), packet_classifier (167 LOC). Session is the most complex (1,457 LOC), handling LXMRouter lifecycle, identity, announce loop, delivery state tracking, thread bridging. |
| **Unit-test maturity**     | High                                            | 9,205 LOC across 15 test files. `test_lxmf_session.py` has 65 test functions across 19 classes. Covers codec, renderer, adapter, session, config, fields, boundaries, pipeline, packet_classifier, live, diagnostics, operational boundaries, evidence, ingress, wrapper.                                                                                       |
...
| ---------- | ---- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Matrix     | 3    | Beta-candidate    | Live evidence recorded H-tier (20/20 pass). Docker SDK-boundary R-tier (15/1 xf pass 2026-05-22; 3/3 E2EE pass 2026-05-25 with third-party inbound confirmed via second nio client). E2EE validated. Most complete adapter. Per STATUS.md: `live-validated`.              |
