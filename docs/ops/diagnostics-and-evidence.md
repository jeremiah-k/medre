...
| `shutdown_rejection`        | In-flight deliveries during shutdown produce `shutdown_drain_timeout`        |
...
| New delivery rejected because shutdown is underway | Suppressed receipt with error `shutdown_drain_timeout` |
