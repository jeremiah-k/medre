...
| `tests/test_alpha_walkthrough_cli.py`   | Split   | 4 domain files: `test_cli_config_and_smoke`, `test_cli_inspect_flow`, `test_cli_replay_flow`, `test_cli_error_paths`. Helper: `helpers/walkthrough.py`.                                                                                                                                                                                                                                                                                                                                                                 |
