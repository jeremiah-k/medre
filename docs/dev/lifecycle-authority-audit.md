...
| `observed_status` rename (done) | `src/medre/core/recovery/models.py`                   | `RecoveryOwnershipAction.observed_status` (formerly `recovered_status`) is the observed outbox status at analysis time. Renamed to clarify that the field reflects observation, not a post-recovery mutation.                                                                                                                |
