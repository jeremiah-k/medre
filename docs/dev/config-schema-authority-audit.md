...
| Schemas reject invalid label types                                                    | ✅                                                  | Schema declares labels as `["string", "null"]`, which rejects booleans at the JSON Schema level (bool is neither string nor null). The typed loader's bool-before-string check is redundant defence-in-depth.                                                                                                                                                                                        |
