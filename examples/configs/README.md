...
| `live-matrix-meshtastic-channel-map.toml` | Multi-channel Matrix ↔ Meshtastic bridge | Matrix + Meshtastic                  | Yes (homeserver + radio)     | Bridges channels 0-7 to separate Matrix rooms via `channel_room_map` |
