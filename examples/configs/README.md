...
| `live-matrix-meshtastic-channel-map.yaml` | Multi-channel Matrix ↔ Meshtastic bridge           | Matrix + Meshtastic                         | Yes (homeserver + radio)     | Maps channel contexts 0-2 via `context_map`; extendable with more entries                                                                                          |
