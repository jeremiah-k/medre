...
class TestCanonicalImports:
    ...
    def test_models_importable(self) -> None:
        from medre.core.recovery.models import RecoveryOwnershipAction  # noqa: F401
        from medre.core.recovery.models import RecoveryOwnershipStatus  # noqa: F401
        from medre.core.recovery.models import RecoverySummary  # noqa: F401
        from medre.core.recovery.models import StartupRecoveryLedger  # noqa: F401

    def test_builder_importable(self) -> None:
        from medre.core.recovery.builder import build_recovery_summary  # noqa: F401
    ...
    def test_recovery_source_importable(self) -> None:
        from medre.core.recovery.recovery_source import RecoverySource  # noqa: F401
