...
def test_forward_matrix_to_mesh_uses_source_origin_label() -> None:
    rc = _crm_config(
...
def test_reverse_mesh_to_matrix_uses_dest_origin_label() -> None:
    rc = _crm_config(
        source_adapters=("matrix_adapter",),
        dest_adapters=("mesh_adapter",),
        source_origin_label="East Net",
...
def test_forward_mesh_to_matrix_uses_source_origin_label() -> None:
    rc = _crm_config(
...
def test_reverse_matrix_to_mesh_uses_dest_origin_label() -> None:
    rc = _crm_config(
        route_id="mesh_bridge",
        source_adapters=("mesh_adapter",),
        dest_adapters=("matrix_adapter",),
...
def test_forward_leg_is_source_label_in_both_orientations() -> None:
    # Matrix source.
    rc_m = _crm_config(
        source_adapters=("matrix_adapter",),
        dest_adapters=("mesh_adapter",),
...
def test_reverse_leg_is_dest_label_in_both_orientations() -> None:
    rc_m = _crm_config(
        source_adapters=("matrix_adapter",),
        dest_adapters=("mesh_adapter",),
        source_origin_label="Src",
...
def test_both_labels_applied_across_all_channels() -> None:
...
def test_dest_to_source_mesh_source_carries_dest_label() -> None:
