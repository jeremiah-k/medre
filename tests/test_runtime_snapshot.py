...
# ---------------------------------------------------------------------------
# Tests: Tranche 3 — Adapter diagnostics, pipeline running, snapshot_scope
# ---------------------------------------------------------------------------
...
class TestAdapterDiagnostics:
    ...
    def test_adapter_diagnostics_exception_does_not_break_snapshot(self) -> None:
        ...
        assert "RuntimeError" in adapter_diag["error"] or "diagnostics engine" in adapter_diag["error"]
